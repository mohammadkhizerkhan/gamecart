    ...
    return (
        ...
        <form class="form">
            <label htmlFor="" class="input-label">
                First name:
                <input type="text" placeholder="Enter your first name here" class="input" value={form.firstname} name="firstname" onChange={handleChange}/>
            </label>
            <label htmlFor="" class="input-label">
                last name:
                <input type="text" placeholder="Enter your last name here" class="input" value={form.lastname} name="lastname" onChange={handleChange}/>
            </label>
            <label htmlFor="" class="input-label">
                Email address:
