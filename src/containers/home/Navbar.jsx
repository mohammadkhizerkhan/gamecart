  ...
  return (
      ...
      <nav class="navbar-landing">
        ...
        <div class="input-icons">
            <div class="icon-cont">
            <svg xmlns="http://www.w3.org/2000/svg" className="icon" link="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" class="iconify iconify--bi" width="25" height="25" preserveAspectRatio="xMidYMid meet" viewBox="0 0 16 16"><path fill="#dfdfdf" d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0a5.5 5.5 0 0 1 11 0z"></path></svg>
            </div>
            <form action="" onSubmit={(e)=>clickSearchHandler(e)}>
            <input type="text" class="input input-search" value={search} onChange={searchHandler}/>
            </form>
          </div>
        </div>
        <ul class="nav-ul">
